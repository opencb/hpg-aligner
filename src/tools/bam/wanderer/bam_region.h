...
EXTERNC void breg_filter(bam_region_t *region, uint8_t filters);
...
EXTERNC void breg_load_window(bam_region_t *region, int chrom, size_t init_pos, size_t end_pos, uint8_t filters, bam_region_window_t *window);
